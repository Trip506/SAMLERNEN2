...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_alias']['0']                 = 'Alias de l\'étiquette';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_alias']['1']                 = 'Veuillez sélectionner une entrée pour l\'alias de l\'étiquette';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_column']['0']                = 'Colonne de la table';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_column']['1']                = 'Veuillez sélectionner la colonne.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_column_type']['attribute']   = 'Attributs MetaModels';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_column_type']['sql']         = 'Colonne de la table SQL';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_filter']['0']                = 'Filter';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_filter']['1']                = 'Sélectionner un filtre à appliquer.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_filterparams']['0']          = 'Paramètres de filtre.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_table']['1']                 = 'Veuillez sélectionner la table de la base de donnée.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['tag_table_type']['sql-table']    = 'Table SQL';
